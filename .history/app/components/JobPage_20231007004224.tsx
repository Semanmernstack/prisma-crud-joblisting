...
function JobPage() {
  ...
  return (
    <div>
        ...
        < input onChange={(e) => setTitle(e.target.value)} value={value} name='title' className=' p-1 border-none outline-none  bg-slate-600 hover:bg-gray-900  text-white' type="text" placeholder='job type' />
